...
export const SOCKET_GLOBAL_URL = process.env.NEXT_PUBLIC_SOCKET_GLOBAL_URL ? process.env.NEXT_PUBLIC_SOCKET_GLOBAL_URL : null;
export const SOCKET_LOCAL_URL = process.env.NEXT_PUBLIC_SOCKET_LOCAL_URL ? process.env.NEXT_PUBLIC_SOCKET_LOCAL_URL : 'http://localhost';
